...
Gem::Specification.new do |s|
  ...
  s.metadata    = {
                    ...
                    'changelog_uri'     => 'https://github.com/cucumber/cucumber/blob/main/cucumber-demo-formatter/CHANGELOG.md',
                    'documentation_uri' => 'https://cucumber.io/docs/cucumber/cucumber-demo-formatter/',
                    'mailing_list_uri'  => 'https://groups.google.com/forum/#!forum/cukes',
                    'source_code_uri'   => 'https://github.com/cucumber/cucumber/blob/main/cucumber-demo-formatter/ruby',
                  }
