...
Next, clone each individual subtree repo (or `git pull -r origin main` if you've already done so)
...
When all components are released, update the main repo:
...
Then finally create a tag in this main repo and push.
